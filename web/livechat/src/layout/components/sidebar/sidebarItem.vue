...
<template>
  ...
  >
    ...
    <template #title>
      <div :style="getDivStyle" class="message-badge-box">
        <template v-if="item.name === 'Replay' && readDotAll">
          <MenuBadge :num="readDotAll" />
        </template>
  ...
  >
    <template #title>
      ...
      <template v-if="item.name === 'MessageMain' && readDotAll">
        <MenuBadge :num="readDotAll" />
      </template>
      <span v-if="layout === 'horizontal'">
