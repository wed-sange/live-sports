...
<template>
  <div
    class="chat-card-box w-full py-[8px]"
  ...
  >
    ...
    <div class="chat-card w-full flex items-start">
      <div
      ...
      <div
        ...
        :class="{
          image: [MessageType.image, MessageType.video].includes(item.type)
        }"
        ref="itemHookRef"
...
.chat-card-box {
  ...
  .chat-card__message {
    ...
    &::after {
      ...
      margin-top: -10px;
      font-size: 20px;
      content: url("../icon/iconLeftMessage.svg");
    }
    ...
    .chat-card {
      ...
      .chat-card__message {
        ...
        ::after {
          ...
          margin-top: -10px;
          font-size: 20px;
          content: url("../icon/iconRightMessage.svg");
        }
