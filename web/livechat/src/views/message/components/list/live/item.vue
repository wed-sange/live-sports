...
<template>
  <div
    class="message-card-box w-full px-[18px] my-[12px] py-[2px] relative cursor-pointer"
    :title="item.name"
    @click="handleClick(item)"
  >
    <div class="message-card w-full flex items-center">
      <div
        class="message-card__cover grow-0 shrink-0 basis-[46px] w-[46px] h-[46px] rounded-[100%] p-[4px]"
      >
        <img
      ...
      <div
        class="grow-0 shrink-0 basis-[calc(100%-46px)] w-[calc(100%-46px)] pl-[4px]"
      >
