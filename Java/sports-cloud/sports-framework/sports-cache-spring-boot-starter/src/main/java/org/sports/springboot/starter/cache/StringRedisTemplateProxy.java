...
package org.sports.springboot.starter.cache;
...
import org.sports.springboot.starter.base.Singleton;
import org.sports.springboot.starter.cache.config.RedisDistributedProperties;
import org.sports.springboot.starter.cache.core.CacheGetFilter;
import org.sports.springboot.starter.cache.core.CacheGetIfAbsent;
import org.sports.springboot.starter.cache.core.CacheLoader;
import org.sports.springboot.starter.cache.toolkit.CacheUtil;
import org.sports.springboot.starter.cache.toolkit.FastJson2Util;
...
public class StringRedisTemplateProxy implements DistributedCache {
    ...
    @Override
    public Long  getExpirationTime(String key, TimeUnit timeUnit) {
