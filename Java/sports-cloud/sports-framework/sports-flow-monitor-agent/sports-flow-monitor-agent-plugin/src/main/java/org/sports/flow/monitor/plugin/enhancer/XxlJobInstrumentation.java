...
import static org.sports.flow.monitor.core.conf.Config.Agent.XXL_JOB_ENHANCE_CLASS;
...
public final class XxlJobInstrumentation implements ClassEnhancePluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "org.sports.flow.monitor.plugin.enhancer.XxlJobInterceptor";
