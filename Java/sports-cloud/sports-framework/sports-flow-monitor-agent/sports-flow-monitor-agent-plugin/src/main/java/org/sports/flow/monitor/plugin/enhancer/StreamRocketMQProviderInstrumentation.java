...
import static org.sports.flow.monitor.core.conf.Config.Agent.SPRING_CLOUD_STREAM_ROCKETMQ_PROVIDER_ENHANCE_CLASS;
...
public final class StreamRocketMQProviderInstrumentation implements ClassEnhancePluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "org.sports.flow.monitor.plugin.enhancer.StreamRocketMQProviderInterceptor";
