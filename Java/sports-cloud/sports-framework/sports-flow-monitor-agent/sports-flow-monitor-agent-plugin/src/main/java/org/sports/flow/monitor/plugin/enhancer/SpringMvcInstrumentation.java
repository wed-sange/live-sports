...
import static org.sports.flow.monitor.core.conf.Config.Agent.SPRING_MVC_ENHANCE_CLASS;
...
public final class SpringMvcInstrumentation implements ClassEnhancePluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "org.sports.flow.monitor.plugin.enhancer.SpringMvcInterceptor";
