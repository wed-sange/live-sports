...
public class GoogleAuthenticator {
     ...
     * @return
     */
    public static Boolean checkCode(Long code, String secret) {
     ...
     * @return
     */
    public static Map<String, String> getQRBarcodeURL(String account) {
        Map<String, String> backMap = new HashMap<>();
        backMap.put("secret", generateSecretKey());
        String url = getQRBarcodeURL(account, "sports", backMap.get("secret"));
        backMap.put("url", url);
        return backMap;
    }
