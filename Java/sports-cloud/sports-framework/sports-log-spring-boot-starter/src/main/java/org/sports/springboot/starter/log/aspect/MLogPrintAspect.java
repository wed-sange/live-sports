...
package org.sports.springboot.starter.log.aspect;
...
public class MLogPrintAspect {
     ...
     * 打印类或方法上的 {@link MLog}
     */
    @Around("@within(org.sports.springboot.starter.log.annotation.MLog) || @annotation(org.sports.springboot.starter.log.annotation.MLog)")
    public Object printMLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (logAnnotation != null) {
                ...
                long duration = SystemClock.now() - startTime;
                if(duration>2000){
                    log.warn("[{}] {}, duration: {}ms, info: {}", methodType, requestURI, duration, JSON.toJSONString(logPrint));
                }else {
                    log.info("[{}] {}, executeTime: {}ms, info: {}", methodType, requestURI, duration, JSON.toJSONString(logPrint));
                }
