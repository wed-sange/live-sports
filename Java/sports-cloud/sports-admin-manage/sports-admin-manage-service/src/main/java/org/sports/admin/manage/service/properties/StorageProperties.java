...
public class StorageProperties {
     ...
     * 亚马逊云配置项
     */
    private AmazonStorageProperties amazon;
    ...
    @Bean
    @ConfigurationProperties(prefix = "storage.amazon")
    public AmazonStorageProperties amazonStorageProperties() {
        return new AmazonStorageProperties();
    }
