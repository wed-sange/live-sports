...
public interface VersionConvert {
    ...
    VersionDO convertToDo(VersionVO bean);

    VersionVO convertToVo(VersionDO bean);

    LatestVersionVO convertToVo2(VersionDO bean);

    List<VersionVO> convertList(List<VersionDO> list);
}
