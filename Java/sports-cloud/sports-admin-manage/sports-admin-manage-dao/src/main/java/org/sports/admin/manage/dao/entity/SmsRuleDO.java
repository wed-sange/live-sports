 ...
 */
@Data
@Schema(description = "短信功能配置信息")
@TableName("t_admin_sms_rule")
public class SmsRuleDO implements Serializable {

    private Long id;

    /**
     * 验证方式json{type:0},{type:0,ids:[]}
     */
    @NotBlank(message = "验证方式不能为空")
    @Schema(description = "验证方式json{type:0},{type:0,ids:[1,2,3,4]}")
