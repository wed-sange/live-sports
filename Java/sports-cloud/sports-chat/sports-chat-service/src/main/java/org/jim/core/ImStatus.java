...
//	C10111(10111,"out group ok!","离开群组成功!"),
	C10112(10112,"out group failed!","离开群组失败!"),
	C10113(10113,"send failed","消息发送失败,请登录后再发送消息"),
	C10114(10114,"send refused","您已被禁言，无法发送消息"),
//	C10114(10114,"log out success","注销成功"),
	C10115(10115,"log out failed","注销失败"),
	;
