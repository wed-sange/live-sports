...
public enum Command{
   ...
   * </pre>
   *
   * <code>COMMAND_OUT_GROUP_REQ = 77;</code>
   */
  COMMAND_EXIT_GROUP_RESP(21),
  /**
   * <pre>
   * 离开聊天群组（直播间）;
   * </pre>
   ...
   * <code>COMMAND_OUT_GROUP_REQ = 77;</code>
   */
  COMMAND_SYSTEM_MESSAGE_SEND_REQ(24),
  /**
   * <pre>
   * 主播开播;
   * </pre>
   ...
   * <code>COMMAND_OUT_GROUP_REQ = 77;</code>
   */
  COMMAND_SYSTEM_FEEDBACK(28),

  /**
   * <pre>
   * 用户总未读私聊消息总数
   */
  USER_TOTAL_UNREAD_MESSAGE(29),
  /**
   * <pre>
   * 比赛分数推送
   */
   ...
   * 主播、运营、助手当前读的用户消息通知
   */
  ANCHOR_READ_USER_MESSAGE(31),
  /**
   * APP用户封禁推送
   */
  FORBIDDEN_APP_USER_MESSAGE(32),
  /**
   * APP用户解封推送
   */
  UNFORBIDDEN_APP_USER_MESSAGE(33),
  /**
   * 关注主播开启直播
   */
  FOLLOW_ANCHOR_OPEN_LIVE(34),
