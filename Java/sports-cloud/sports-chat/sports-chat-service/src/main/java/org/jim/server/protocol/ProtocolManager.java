...
public class ProtocolManager implements ImConst{
	...
	public static class Packet{
		...
		public static ImPacket  dataInCorrect(ImChannelContext imChannelContext) throws ImException{
			...
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.FALSE);
		...
		public static ImPacket  dataInCorrect(ImChannelContext imChannelContext, String sendId) throws ImException{
			RespBody chatDataInCorrectRespPacket = new RespBody(Command.COMMAND_CHAT_RESP,ImStatus.C10002);
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.FALSE);
			chatDataInCorrectRespPacket.setSendId(sendId);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, imChannelContext);
			respPacket.setStatus(ImStatus.C10002);
			return respPacket;
		}
		...
		public static ImPacket  success(ImChannelContext imChannelContext) throws ImException{
			...
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.TRUE);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, imChannelContext);
		...
		public static ImPacket anonymousSend(ImChannelContext channelContext) throws ImException {
			RespBody chatDataInCorrectRespPacket = new RespBody(Command.COMMAND_CHAT_RESP,ImStatus.C10113);
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.FALSE);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, channelContext);
			respPacket.setStatus(ImStatus.C10002);
			return respPacket;
		}

		public static ImPacket anonymousSend(ImChannelContext channelContext, String sendId) throws ImException {
			RespBody chatDataInCorrectRespPacket = new RespBody(Command.COMMAND_CHAT_RESP,ImStatus.C10113);
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.FALSE);
			chatDataInCorrectRespPacket.setSendId(sendId);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, channelContext);
		...
		public static ImPacket banUserSend(ImChannelContext channelContext, String sendId) throws ImException {
			RespBody chatDataInCorrectRespPacket = new RespBody(Command.COMMAND_CHAT_RESP,ImStatus.C10114);
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.FALSE);
			chatDataInCorrectRespPacket.setSendId(sendId);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, channelContext);
			respPacket.setStatus(ImStatus.C10114);
			return respPacket;
		}

		public static ImPacket success(ImChannelContext channelContext, String sendId) throws ImException {
			RespBody chatDataInCorrectRespPacket = new RespBody(Command.COMMAND_CHAT_RESP, ImStatus.C10000);
			chatDataInCorrectRespPacket.setSuccess(WsResponseStatus.TRUE);
			chatDataInCorrectRespPacket.setSendId(sendId);
			ImPacket respPacket = Converter.respPacket(chatDataInCorrectRespPacket, channelContext);
