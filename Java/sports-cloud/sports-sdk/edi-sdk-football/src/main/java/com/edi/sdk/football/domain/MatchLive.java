...
public class MatchLive {
	/**
	 * ["纳米比赛id - int","比赛状态，详见状态码->
	 * 比赛状态 - int",
	 * ["主队比分(常规时间) - int","主队半场比分 -
	 * int","主队红牌 - int","主队黄牌 - int","主队角球，-1表示没有角球数据 -
	 * int","主队加时比分(120分钟，即包括常规时间比分)，加时赛才有 - int","主队点球大战比分(不包含常规时间及加时赛比分)，点球大战才有 -
	 * int"],
	 * ["客队比分(常规时间) - int","客队半场比分 - int","客队红牌 - int","客队黄牌 -
	 * int","客队角球，-1表示没有角球数据 - int","客队加时比分(120分钟，即包括常规时间比分)，加时赛才有 -
	 * int","客队点球大战比分(不包含常规时间及加时赛比分)，点球大战才有 - int"],
	 * "开球时间戳，上/下半场开球时间(根据比赛状态判断) -
	 * int","备注信息，可忽略 - string"]比分字段说明<br/>
