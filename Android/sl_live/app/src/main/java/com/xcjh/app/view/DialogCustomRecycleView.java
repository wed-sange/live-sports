 ...
 */
public class DialogCustomRecycleView extends RecyclerView implements ScrollController {

    public DialogCustomRecycleView(@NonNull Context context) {
        super(context);
    }

    public DialogCustomRecycleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DialogCustomRecycleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
