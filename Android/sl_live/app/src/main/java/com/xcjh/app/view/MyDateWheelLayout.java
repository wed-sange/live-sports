...
public class MyDateWheelLayout extends BaseWheelLayout implements ScrollController {
    ...
    public MyDateWheelLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyDateWheelLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MyDateWheelLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
