 ...
 * 视情况酌情使用
 */
class ZbScrollView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : NestedScrollView(context, attrs, defStyleAttr) {

    private val TAG: String = ZbScrollView::class.java.simpleName
    ...
    override fun onFinishInflate() {
        ...
        if (childView.childCount == 2) {
            ...
            throw  IllegalStateException("$TAG 专为嵌套滚动而设计，只能有两个直接子级")
        }
    }
